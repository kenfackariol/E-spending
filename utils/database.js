...
export function dropTable() {
  return new Promise((resolve, reject) => {
    ...
    db.transaction(tx => {
      tx.executeSql('DROP TABLE Categorie');
...
export function initDB() {
  return new Promise((resolve, reject) => {
    ...
    db.transaction(tx => {
      ...
      tx.executeSql('CREATE TABLE IF NOT EXISTS Depense (id INTEGER PRIMARY KEY AUTOINCREMENT, id_utilisateur INTEGER, categorie TEXT, montant REAL, date TEXT, commentaire TEXT, FOREIGN KEY (id_utilisateur) REFERENCES Utilisateur(id))');
